...
        ment = "[" + user_name + "](tg://user?id=" + str(user_id) + ")"
        if not MUST_JOIN: 
            return
        try:
            try:
...
                try:
                    await message.reply(
                        f"Hallo {ment}. Agar Bisa Menggunakan Bot Anda Harus Masuk Ke Channel Updates Bot Terlebih Dahulu!. Silahkan Klik Tombol Di Bawah Untuk Join Ke Channel Update Bot.",
